    ...
    return (
        <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f8fafc', padding: '1rem' }}>
            ...
            <div style={{ backgroundColor: 'white', padding: '2.5rem', borderRadius: '1rem', width: '100%', maxWidth: '400px', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)' }}>
                <h1 style={{ marginBottom: '0.5rem', fontSize: '1.5rem', fontWeight: 700, textAlign: 'center', color: '#0f172a' }}>Start your journey</h1>
                <p style={{ marginBottom: '2rem', color: '#64748b', textAlign: 'center' }}>Create an account to manage your ESG data</p>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                    <div>
                        <label htmlFor="name" style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.875rem', fontWeight: 500, color: '#334155' }}>Full Name</label>
                        <input
                            id="name"
                            type="text"
                            value={name}
                    ...
                    <div>
                        <label htmlFor="password" style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.875rem', fontWeight: 500, color: '#334155' }}>Password</label>
                        <input
                            id="password"
                            type="password"
                            value={password}
